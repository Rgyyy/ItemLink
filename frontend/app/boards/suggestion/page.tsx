...
function SuggestionBoardContent() {
  ...
  const fetchPosts = async () => {
    try {
      setLoading(true);
      const params: any = { boardType: 'SUGGESTION', limit: 50 };
      ...
      <section className="bg-white border-b py-6">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-4">
            ...
            {isAuthenticated && (
              <Link href="/trades/new?boardType=SUGGESTION">
                <Button variant="primary">+ 건의하기</Button>
              </Link>
            )}
          </div>
          <input
